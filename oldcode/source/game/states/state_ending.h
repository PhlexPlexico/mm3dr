...
struct StateEnding : State {
  ...
  void Init() { rnd::util::GetPointer<void(StateEnding&)>(0x15D20C)(*this); }
  void Calc() { rnd::util::GetPointer<void(StateEnding&)>(0x16EC90)(*this); }
  void ShowMessage(int id) { rnd::util::GetPointer<void(StateEnding&, int)>(0x18CD10)(*this, id); }
