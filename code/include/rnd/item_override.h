...
namespace rnd {
  ...
  enum class GetItemID : u32 {
    ...
    /* 0x51 */ // GI_ERROR_YELLOW_RUPPEE, // ***ERROR TEXT Get Item Nothing in hand at first - then subsequently yellow
               // rupee. No rupee increment.
    ...
    /* 0x9F */ GI_SHIELD_HERO_2_STOLEN, // Code that treats this as hero's shield is unused, so take with a grain of
                                        // salt
    ...
    /* 0xA8 */ // GI_ERROR_NOTHING_A8, // ***ERROR TEXT Get Item Nothing in hand - Green Rupee with Ocarina in
               // Inventory,
    /* 0xA9 */ GI_BOTTLE = 0xA9, // Bottle purchase back text.
    /* 0xAA */ GI_LETTER_TO_KAFEI,
    /* 0xAB */ GI_PENDANT_OF_MEMORIES,
    /* 0xAC */ // GI_ERROR_NOTHING_AC, // ***ERROR TEXT Get Item Nothing in hand - Green Rupee with Ocarina in
               // Inventory,
    /* 0xAD */ // GI_ERROR_NOTHING_AD, // ***ERROR TEXT Get Item Nothing in hand - Green Rupee with Ocarina in
               // Inventory,
    /* 0xAE */ // GI_ERROR_NOTHING_AE, // ***ERROR TEXT Get Item Nothing in hand - Green Rupee with Ocarina in
               // Inventory,
    /* 0xAF */ // GI_ERROR_NOTHING_AF, // ***ERROR TEXT Get Item Nothing in hand - Green Rupee with Ocarina in
               // Inventory,
    /* 0xB0 */ // GI_ERROR_NOTHING_B0, // ***ERROR TEXT Get Item Nothing in hand - Green Rupee with Ocarina in
               // Inventory,
    /* 0xB1 */ // GI_ERROR_NOTHING_B1, // ***ERROR TEXT Get Item Nothing in hand - Green Rupee with Ocarina in
               // Inventory,
    /* 0xB2 */ // GI_ERROR_NOTHING_B2, // ***ERROR TEXT Get Item Nothing in hand - Green Rupee with Ocarina in
               // Inventory,
    /* 0xB3 */ // GI_ERROR_SUN_MASK_B3, // ***ERROR TEXT Get Item Sun's Mask in hand - Takes away ocarina if you have
               // it.
