...
namespace rnd {
  ...
  enum class StartingBottleSetting : u8 { 
    STARTINGBOTTLE_NONE,
    STARTINGBOTTLE_EMPTY_BOTTLE = 0x12, //0x01
    STARTINGBOTTLE_RED_POTION = 0x13, //0x02
    STARTINGBOTTLE_GREEN_POTION = 0x14, //0x03
    STARTINGBOTTLE_BLUE_POTION = 0x15, //0x04
    STARTINGBOTTLE_FAIRY = 0x16, //0x05
    STARTINGBOTTLE_DEKU_PRINCESS = 0x17, //0x06
    STARTINGBOTTLE_MILK = 0x18, //0x07
    STARTINGBOTTLE_MILK_HALF = 0x19, //0x08
    STARTINGBOTTLE_FISH = 0x1a, //0x09
    STARTINGBOTTLE_BUGS = 0x1b, //0x0a
    STARTINGBOTTLE_BIG_POE = 0x1E, //0x0b
    STARTINGBOTTLE_SPRING_WATER,
    STARTINGBOTTLE_HOT_SPRING_WATER = 0x20, //0x0d
    STARTINGBOTTLE_ZORA_EGG = 0x21, //0x0e
    STARTINGBOTTLE_GOLD_DUST = 0x22, //0x10
    STARTINGBOTTLE_MAGICAL_MUSHROOM = 0x23, //0x11
    STARTINGBOTTLE_SEAHORSE = 0x24, //0x12
    STARTINGBOTTLE_CHATEAU_ROMANI = 0x25, //0x13
    STARTINGBOTTLE_MYSTERY_MILK = 0x26, //0x14
    STARTINGBOTTLE_MYSTERY_MILK_SPOILED = 0x27, //0x15
  };
