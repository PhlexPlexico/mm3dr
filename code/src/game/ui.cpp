...
void LayoutBase::calc(float speed) {
  ...
  rnd::util::GetPointer<void(LayoutBase*, float)>(0x161AE8)(this, speed);
}
...
void Widget::PrintDebug() {
  ...
  rnd::util::Print("%p %s tx=(%f %f %f) mtx=(%f %f %f) %08lx %08lx %f", this, GetName(), tx.x, tx.y,
...
void AnimPlayer::SetFrame(float frame) {
  rnd::util::GetPointer<void(AnimPlayer*, float)>(0x192AE0)(this, frame);
}
...
LayoutMgr& LayoutMgr::Instance() {
  return rnd::util::GetInstance<LayoutMgr>(0x7CDC9C, 0x6B0AFC, 0x16963C);
}

void LayoutMgr::FreeLayout(Layout* layout) {
  rnd::util::GetPointer<void(LayoutMgr&, Layout*)>(0x169634)(*this, layout);
}

Layout* LayoutMgr::MakeLayout(int file, int x) {
  return rnd::util::GetPointer<Layout*(LayoutMgr&, int, int)>(0x16962C)(*this, file, x);
}
...
Project& Project::Instance() {
  return *rnd::util::GetPointer<Project>(0x7CDCA0);
}

int Project::GetLayoutId(const char* name) {
  return rnd::util::GetPointer<int(Project&, const char*)>(0x16A014)(*this, name);
}

int Project::GetPackageId(const char* name) {
  return rnd::util::GetPointer<int(Project&, const char*)>(0x15A86C)(*this, name);
}

bool Project::LoadPackage(int id, bool x) {
  return rnd::util::GetPointer<bool(Project&, int, bool)>(0x15141C)(*this, id, x);
}

bool Project::UnloadPackage(int id) {
  return rnd::util::GetPointer<bool(Project&, int)>(0x161CB4)(*this, id);
}

bool Project::IsLoading() const {
  return rnd::util::GetPointer<bool(const Project&)>(0x180190)(*this);
}

LayoutDrawMgr& LayoutDrawMgr::Instance() {
  return *rnd::util::GetPointer<LayoutDrawMgr*()>(0x169824)();
}

void LayoutDrawMgr::ControlLayout(Layout* layout, int a, int b) {
  rnd::util::GetPointer<void(LayoutDrawMgr*, Layout*, int, int)>(0x17EC58)(this, layout, a, b);
}
