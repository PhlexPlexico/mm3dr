...
namespace game {
  ...
  void ObjectBankArchive::init(ObjectBankArchive* obj_bank_archive, u32 actor_id, ResArchiveHeader* data, int size, char set_field_5c) {
  ...
  void* ObjectBankArchive::getCmbFile(ObjectBankArchive* obj_bank_archive, u32 cmb_file_index, u32 archive_type) {
    return rnd::util::GetPointer<void*(ObjectBankArchive*, u32, u32)>(0x1F5C00)(obj_bank_archive, cmb_file_index, archive_type);
  }
  void ObjectBankArchive::free(ObjectBankArchive* obj_bank_archive) {
